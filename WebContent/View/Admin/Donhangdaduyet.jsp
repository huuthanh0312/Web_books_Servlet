...
<head>
<meta charset="UTF-8">
<title>Danh Sách Đơn Hàng Đã Duyệt</title>
    <!-- Fontfaces CSS-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Danh Sách Đơn Hàng Đã Duyệt</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                      ...
                                      <% 
										...
										%>
                                          <tr >
							                ...
							                <a href="AdminXuLyDonHang?mahoadon=<%=dsdonhang.get(i).getMaHoaDon()%>&duyet=3" class="button"> Hủy Đơn Hàng </a> 
							                </td>
                                          </tr>
