			...
			<div class="container">
				<div class="row">
					...
					<div class="shop-top" style="border-bottom: 1px solid #ddd;	background: #f6f7fb;padding: 20px 15px 10px 15px;">
						<h2 style="text-align: center;color: #424646;">GIỎ HÀNG</h2>
					</div>
					<!--/ End Shop Top -->	
					<!-- Shopping Cart -->
									...
									<table class="table table-responsive table-hover" >
									    ...
									    <%for(int i=0;i<n;i++){ %>
											<tr>
											    ...
											    <td class="text-center" >
								                  	<form action="GiohangController?masach=<%=ghbo.ds.get(i).getMasach()%>" method="post">
											        <input type="number" name="soluong" value="<%=ghbo.ds.get(i).getSoluong()%>"> <!-- so luong --> 
											        <input style="padding: 5px 12px;" class="btn bg-warning" type="submit" value="Sửa"> 
													</form>
												</td>			
												<td class="text-center"><span><%=ghbo.ds.get(i).getThanhtien()%> Đ</span></td>
												<td class="text-center">
													<a href="GiohangController?masach=<%=ghbo.ds.get(i).getMasach()%>"><i class="ti-trash remove-icon"></i></a>
												</td>
											</tr>
									...
									<div class="total-amount">
										<div class="row">
											<div class="col-lg-7 col-md-7 col-12">
												<div class="left">
														<a href="SachController" class="btn"><span class="fa fa-arrow-left"></span> Tiếp Tục Mua Hàng</a>
												</div>
											</div>
											<div class="col-lg-5 col-md-7 col-12">
												<div class="right">
														<a href="XuLyThanhToanController" class="btn">Thanh Toán <span class="fa fa-arrow-right"></span></a>
												</div>	
											</div>							
										</div>
									</div>
