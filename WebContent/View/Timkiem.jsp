			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="col-12">
								...
								<div class="shop-top">
									...
									<ul class="view-mode">
										...
										Từ Khóa Tìm Kiếm : "<b><%=request.getAttribute("Ten") %></b>"
										<%}%>
										</li>
									</ul>
								</div>
						...
						<%ArrayList<SachBean> ds = (ArrayList<SachBean>) request.getAttribute("lsttk");%>	
						<div class="row">
						<h3><%= request.getAttribute("Loitimkiem") != null ? request.getAttribute("Loitimkiem") :"" %></h3>		
			  			<% for(SachBean s : ds){%>
						<div class="col-lg-4 col-md-6 col-12">
							...
							<div class="col-12 ">
								...
								<%
									if(request.getAttribute("Loitimkiem")==null){
									...
									if(trang==1 & tongtrang == 1) {%>
										...
										<li class="page-item">
											<a class="page-link"style="background: #F7941D !important;" 
											href="TimkiemController?pageid=<%=trang%>&txttk=<%request.getAttribute("Ten");%>">
											<%out.print(trang);%></a>
										</li>
									...
									if(trang==1) {%>
										...
										<li class="page-item">
											<a class="page-link" href="TimkiemController?pageid=<%=(trang+1)%>&txttk=<%request.getAttribute("Ten");%>">
											<%out.print((trang+1));%></a>
										</li>
										<li class="page-item">
											<a class="page-link"href="TimkiemController?pageid=<%=(trang+1)%>&txttk=<%=request.getAttribute("Ten")%>">
									...
									<% } else {
										...
										<li class="page-item">
											<a class="page-link" style="background: #F7941D !important;"
											 href="TimkiemController?pageid=${numberpage}&txttk=<%=request.getAttribute("Ten")%>">
											 <%out.print(trang);%></a>
										</li>
										<li style="pointer-events: none; color: #ccc;">
											<a class="page-link" href="">Next</a>
									...
									<% } else  {%>
										<li class="page-item"><a class="page-link"
												href="TimkiemController?pageid=<%=(trang-1)%>&txttk=<%=request.getAttribute("Ten")%>">
												Prev</a></li>
										<li class="page-item">
											<a class="page-link" style="background: #F7941D !important;" 
											href="TimkiemController?pageid=<%=trang%>&txttk=<%=request.getAttribute("Ten")%>">
