			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="col-12">
								...
								<div class="shop-top">
									...
									<ul class="view-mode">
										...
										<%} else {
											if(request.getAttribute("MaLoai") != null) {
										%>
										Thể Loại Sách : 
										 <b>
										<%for(LoaiBean l: dsloai){ 
											if(request.getAttribute("MaLoai").equals(l.getMaloai()))
						...
						<%
						ArrayList<SachBean> ds = (ArrayList<SachBean>) request.getAttribute("lstma");
								...
								<%							
									...
									if(trang==1 & tongtrang == 1) {%>
										...
										<li class="page-item">
											...
											href="TheloaiController?pageid=<%=trang%>&ml=<%=request.getAttribute("MaLoai")%>">
											<%out.print(trang);%></a>
										</li>
									...
									if(trang==1) {%>
										...
										<li class="page-item">
											<a class="page-link" href="TheloaiController?pageid=<%=(trang+1)%>&ml=<%=request.getAttribute("MaLoai")%>">
											<%out.print((trang+1));%></a>
										</li>
										<li class="page-item">
											<a class="page-link"href="TheloaiController?pageid=<%=(trang+1)%>&ml=<%=request.getAttribute("MaLoai")%>">
									...
									<% } else {
										...
										<li class="page-item">
											<a class="page-link" style="background: #F7941D !important;"
											 href="TheloaiController?pageid=${numberpage}&ml=<%=request.getAttribute("MaLoai")%>">
											 <%out.print(trang);%></a>
										</li>
										<li style="pointer-events: none; color: #ccc;">
											<a class="page-link" href="">Next</a>
									...
									<% } else  {%>
										<li class="page-item"><a class="page-link"
												href="TheloaiController?pageid=<%=(trang-1)%>&ml=<%=request.getAttribute("MaLoai")%>">
												Prev</a></li>
										<li class="page-item">
											<a class="page-link" style="background: #F7941D !important;" 
											href="TheloaiController?pageid=<%=trang%>&ml=<%=request.getAttribute("MaLoai")%>">
