...
@WebServlet("/AdminXuLyDonHang")
public class AdminXuLyDonHang extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public AdminXuLyDonHang() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			if(MaHoaDon != null & duyet != null){	//neu tim theo ma
				if(ad.XuLyDonHang(Integer.parseInt(MaHoaDon) , Integer.parseInt(duyet) )) {
					response.sendRedirect("AdminXuLyDonHang");	
					}
			} else {
