			...
			<div class="container">
				<div class="row">
					...
					<div class="shop-top" style="border-bottom: 1px solid #ddd;	background: #f6f7fb;padding: 20px 15px 10px 15px;">
						<h2 style="text-align: center;color: #424646;">Thông Tin Tài Khoản</h2>
					</div>
					<!--/ End Shop Top -->	
					<!-- Shopping Cart -->
					<div class="shopping-cart section">
						<div class="container">
							<div class="row">
								<div class="col-12 p-l-6">
								<%
									if(request.getAttribute("thongtinkh")!=null){
										ArrayList<KhachhangBean> dskh =(ArrayList<KhachhangBean>)request.getAttribute("thongtinkh");	
								   		for(KhachhangBean kh : dskh){ %>
								   	<p >Họ Và Tên: <b  > <%=kh.getHoten()%></b> <p/><br>
								   	<p >Số Điện Thoại:  <b  class=" text-center"> <%=kh.getSodt()%></b> <p/><br>
								   	<p >Địa Chỉ:  <b > <%=kh.getDiachi()%></b> <p/><br>
								   	<p >Email: <b > <%=kh.getEmail()%></b> <p/><br>
								<% } }%>
								  </div>
							</div>	  
							<div class="row">
									...
									<div class="total-amount">
										<div class="row">
											<div class="col-lg-7 col-md-7 col-12">
												<div class="left">
														<a href="SachController" class="btn " style="background: #212529; color: #fff"><span class="fa fa-arrow-left"></span> Trở Lại</a>
												</div>
											</div>						
										</div>
									</div>
